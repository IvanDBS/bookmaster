<template>
  <div class="space-y-5">
    <h4 class="text-sm font-semibold text-gray-900">Выберите мастера для услуги "{{ selectedServiceType }}"</h4>
...
<script setup>
const props = defineProps({ masters: Array, selectedServiceType: String, selectedMasterId: Number })
defineEmits(['select'])
