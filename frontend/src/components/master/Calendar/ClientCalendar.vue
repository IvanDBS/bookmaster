    ...
    <div class="px-6 py-4 border-b border-gray-200">
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-2">
          ...
          <span class="text-lg font-semibold text-gray-900">{{ currentMonthName }} {{ currentYear }}</span>
      ...
      <div class="grid grid-cols-7 gap-1">
        <div v-for="date in calendarDates" :key="date.key" 
             ...
             class="relative"
                ...
                date.isSelected ? 'border-blue-500 text-gray-900 shadow-lg scale-105' : 'border-transparent',
...
watch(() => props.masterId, (newMasterId) => {
