...
RSpec.describe WorkingSchedule, type: :model do
  ...
  describe 'validations' do
    ...
    context 'when is_working is false' do
      let(:schedule) { build(:working_schedule, is_working: false, start_time: nil, end_time: nil, slot_duration_minutes: nil) }
  ...
  describe '#generate_slots_for_date' do
    let(:schedule) { build(:working_schedule, is_working: true, start_time: '09:00', end_time: '19:00', slot_duration_minutes: 60) }
  ...
  describe '#working_duration_minutes' do
    ...
    context 'when schedule is working' do
      let(:schedule) { build(:working_schedule, start_time: '09:00', end_time: '19:00', lunch_start: '13:00', lunch_end: '14:00') }
