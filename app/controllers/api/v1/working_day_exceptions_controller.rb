  ...
  module V1
    class WorkingDayExceptionsController < Api::V1::BaseController
      ...
      def toggle
        ...
        return render_error(code: 'validation_error', message: 'Дата не передана', status: :unprocessable_entity) unless date
        ...
        if target_is_working
          ...
          if schedule.lunch_start && schedule.lunch_end
            if schedule.end_time <= schedule.start_time || schedule.lunch_end <= schedule.lunch_start ||
